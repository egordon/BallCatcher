...
{
    if (Clock_6_CLKEN & Clock_6_CLKEN_MASK)
    {
...
*
*******************************************************************************/
void Clock_6_SetModeRegister(uint8 clkMode) 
{
    Clock_6_MOD_SRC |= clkMode & Clock_6_MODE_MASK;
}
...
*
*******************************************************************************/
void Clock_6_ClearModeRegister(uint8 clkMode) 
{
    Clock_6_MOD_SRC &= ~clkMode | ~Clock_6_MODE_MASK;
}
...
{
    return Clock_6_MOD_SRC & Clock_6_MODE_MASK;
}
...
void Clock_6_SetSourceRegister(uint8 clkSource) 
{
    ...
    if (oldSrc != CYCLK_SRC_SEL_CLK_SYNC_D && clkSource == CYCLK_SRC_SEL_CLK_SYNC_D && currDiv == 0)
    {
        ...
        Clock_6_MOD_SRC |= CYCLK_SSS;
        Clock_6_MOD_SRC =
            (Clock_6_MOD_SRC & ~Clock_6_SRC_SEL_MSK) | clkSource;
    }
