...
void Clock_8_SetDividerRegister(uint16 clkDivider, uint8 reset) ;
...
#define Clock_8_SetDivider(clkDivider)         Clock_8_SetDividerRegister(clkDivider, 1)
#define Clock_8_SetDividerValue(clkDivider)    Clock_8_SetDividerRegister((clkDivider) - 1, 1)
...
#define Clock_8_SetPhaseValue(clkPhase)        Clock_8_SetPhaseRegister((clkPhase) + 1)
#endif
