...
void Clock_5_SetDividerRegister(uint16 clkDivider, uint8 reset) ;
...
#define Clock_5_SetDivider(clkDivider)         Clock_5_SetDividerRegister(clkDivider, 1)
#define Clock_5_SetDividerValue(clkDivider)    Clock_5_SetDividerRegister((clkDivider) - 1, 1)
...
#define Clock_5_SetPhaseValue(clkPhase)        Clock_5_SetPhaseRegister((clkPhase) + 1)
#endif
