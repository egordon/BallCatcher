...
void Clock_3_SetDividerRegister(uint16 clkDivider, uint8 reset) ;
...
#define Clock_3_SetDivider(clkDivider)         Clock_3_SetDividerRegister(clkDivider, 1)
#define Clock_3_SetDividerValue(clkDivider)    Clock_3_SetDividerRegister((clkDivider) - 1, 1)
...
#define Clock_3_SetPhaseValue(clkPhase)        Clock_3_SetPhaseRegister((clkPhase) + 1)
#endif
