...
void PWM_clk_SetDividerRegister(uint16 clkDivider, uint8 reset) ;
...
#define PWM_clk_SetDivider(clkDivider)         PWM_clk_SetDividerRegister(clkDivider, 1)
#define PWM_clk_SetDividerValue(clkDivider)    PWM_clk_SetDividerRegister((clkDivider) - 1, 1)
...
#define PWM_clk_SetPhaseValue(clkPhase)        PWM_clk_SetPhaseRegister((clkPhase) + 1)
#endif
