...
#define ADC_CFG1_DSM_CR5            (0X0Eu)
#define ADC_CFG1_DSM_CR6            (0X3Eu)
...
#define ADC_CFG1_CP_CLOCK_FREQ      (1000000u)
#define ADC_CFG1_REFERENCE_VOLTAGE  (1.2500)
#define ADC_CFG1_COUNTS_PER_VOLT    (13107u)
#define ADC_CFG1_IDEAL_DEC_GAIN     (0X8E58u)

#define ADC_CFG1_IDEAL_ODDDEC_GAIN  (0X8000u)

/* Input and DAC Cap values in pF */
#define ADC_CFG1_IPCAP1VALUE        (0X0570u)
#define ADC_CFG1_DACAPVALUE         (0X1830u)
