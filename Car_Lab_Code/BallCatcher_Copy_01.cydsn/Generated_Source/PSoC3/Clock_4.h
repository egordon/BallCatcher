...
void Clock_4_SetDividerRegister(uint16 clkDivider, uint8 reset) ;
...
#define Clock_4_SetDivider(clkDivider)         Clock_4_SetDividerRegister(clkDivider, 1)
#define Clock_4_SetDividerValue(clkDivider)    Clock_4_SetDividerRegister((clkDivider) - 1, 1)
...
#define Clock_4_SetPhaseValue(clkPhase)        Clock_4_SetPhaseRegister((clkPhase) + 1)
#endif
