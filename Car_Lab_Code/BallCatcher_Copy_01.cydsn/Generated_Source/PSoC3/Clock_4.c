...
void Clock_4_Start(void) 
{
    ...
    Clock_4_CLKEN |= Clock_4_CLKEN_MASK;
}


/*******************************************************************************
* Function Name: Clock_4_Stop
********************************************************************************
* Summary:
...
/*******************************************************************************
* Function Name: Clock_4_StopBlock
********************************************************************************
* Summary:
...
{
    if (Clock_4_CLKEN & Clock_4_CLKEN_MASK)
    {
        ...
        oldDivider = CY_GET_REG16(Clock_4_DIV_PTR);
...
*
*******************************************************************************/
void Clock_4_SetModeRegister(uint8 clkMode) 
{
    Clock_4_MOD_SRC |= clkMode & Clock_4_MODE_MASK;
}
...
*
*******************************************************************************/
void Clock_4_ClearModeRegister(uint8 clkMode) 
{
    Clock_4_MOD_SRC &= ~clkMode | ~Clock_4_MODE_MASK;
}
...
{
    return Clock_4_MOD_SRC & Clock_4_MODE_MASK;
}
...
void Clock_4_SetSourceRegister(uint8 clkSource) 
{
    ...
    if (oldSrc != CYCLK_SRC_SEL_CLK_SYNC_D && clkSource == CYCLK_SRC_SEL_CLK_SYNC_D && currDiv == 0)
    {
        ...
        Clock_4_MOD_SRC |= CYCLK_SSS;
        Clock_4_MOD_SRC =
            (Clock_4_MOD_SRC & ~Clock_4_SRC_SEL_MSK) | clkSource;
    }
