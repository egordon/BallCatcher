...
{
    if (Clock_5_CLKEN & Clock_5_CLKEN_MASK)
    {
...
*
*******************************************************************************/
void Clock_5_SetModeRegister(uint8 clkMode) 
{
    Clock_5_MOD_SRC |= clkMode & Clock_5_MODE_MASK;
}
...
*
*******************************************************************************/
void Clock_5_ClearModeRegister(uint8 clkMode) 
{
    Clock_5_MOD_SRC &= ~clkMode | ~Clock_5_MODE_MASK;
}
...
{
    return Clock_5_MOD_SRC & Clock_5_MODE_MASK;
}
...
void Clock_5_SetSourceRegister(uint8 clkSource) 
{
    ...
    if (oldSrc != CYCLK_SRC_SEL_CLK_SYNC_D && clkSource == CYCLK_SRC_SEL_CLK_SYNC_D && currDiv == 0)
    {
        ...
        Clock_5_MOD_SRC |= CYCLK_SSS;
        Clock_5_MOD_SRC =
            (Clock_5_MOD_SRC & ~Clock_5_SRC_SEL_MSK) | clkSource;
    }
